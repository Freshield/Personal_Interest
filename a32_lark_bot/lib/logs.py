...
@File: logs.py
@Time: 2023-03-07 21:27
@Last_update: 2023-03-07 21:27
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
import logging
import sys
from config import LOGS_NUM, LOGS_STREAM_LEVEL, LOGS_FILE_LEVEL, LOGS_DIR_NAME
...
class MultiprocessHandler(logging.FileHandler):
    def __init__(self, filename: str, when='D', backupCount=0, encoding=None, delay=False):
        ...
        self.filefmt = os.path.join('.', LOGS_DIR_NAME, "%s-%s.log" % (self.prefix, self.suffix))
